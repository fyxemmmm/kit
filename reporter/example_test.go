...
func TestUserSignUp(t *testing.T) {
	_ = os.Setenv("MIXPANEL_TOKEN", "947bca6172a824b18b3ffae793196f22")
...
func TestSendEventExample1(t *testing.T) {
	_ = os.Setenv("SLACK_CHANNEL_ADDR", "https://hooks.slack.com/services/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J")
	_ = os.Setenv("MIXPANEL_TOKEN", "947bca6172a824b18b3ffae793196f22")
...
func TestBenchmark(t *testing.T) {
	_ = os.Setenv("SLACK_CHANNEL_ADDR", "https://hooks.slack.com/services/TC80547N2/B021X7QURDM/ccccqsl6w22vX7cZz0iRm")
	_ = os.Setenv("MIXPANEL_TOKEN", "947bca6172a824b18b3ffae793196f22")
	const channelName = "testchannel1"
...
func TestTimeoutEvent(t *testing.T) {
	_ = os.Setenv("SLACK_CHANNEL_ADDR", "https://hooks.slack.com/services/TC80547N2/B021X7QURDM/HMdJziqslxzczxcz0iRm")
	_ = os.Setenv("MIXPANEL_TOKEN", "947bca6172a824b18b3ffae793196f22")
	const channelName = "testchannel1"
